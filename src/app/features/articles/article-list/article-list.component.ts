...
export class ArticleListComponent implements OnInit, OnDestroy {
  /**
   * Maximum number of articles to load per page
   */
  @Input() limit: number;
  
  /**
   * Configuration for the article list, including type, filters, and pagination
   */
    ...
    this.articlesService.query(queryConfig)
      .subscribe({
        ...
        error: (err) => {
          ...
          // Could add error handling service or display error message to user
        }
      });
  }
}